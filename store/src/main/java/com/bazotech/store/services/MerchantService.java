...
public class MerchantService {
	...
	public void updateMerchantInfo() {
		...
		var updatedMerchant = merchantRepository.save(merchantToUpdate);	
		logger.info("UpdatedMerchantInfo:logger:" + updatedMerchant.toString());
	}
	...
	public void addMerchantAddress(Long merchantID) {
		...
		var newAddress = BusinessAddress.builder()
										...
										.country("Uganda")
										.addressType(BusinessAddress.AddressType.SECONDARY)
										.description("Updated Description for the address")
										.merchant(merchant)
										.vendor(null)
										.build();
		
		merchant.addBusinessAddress(newAddress);
		
		merchantRepository.save(merchant);
		logger.info("AddedMerchantAddress:logger:" + merchant.toString());
	}
	...
	public void deleteMerchant(Long merchantID) {
		...
		logger.info("DeletedMerchant:logger: Merchant with ID " + merchantID + " has been deleted.");
	}
