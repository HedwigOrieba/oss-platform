...
/* table vendor_merchant_associations */
create table if not exists vendor_merchant_associations (
	
    association_id bigint not null auto_increment primary key,
    ...
    constraint unique_vendor_merchant unique (vendor_id, merchant_id)
    
);

create index idx_vendor_merchant_vendor on vendor_merchant_associations(vendor_id);
create index idx_vendor_merchant_merchant on vendor_merchant_associations(merchant_id);
